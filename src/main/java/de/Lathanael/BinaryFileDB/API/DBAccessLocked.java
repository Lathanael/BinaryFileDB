...
public class DBAccessLocked {
	...
	/**
	 * This will load and return a new DBAccessLocked instance with standard settings.
	 ...
	 * @throws CacheSizeException
	 */
	public DBAccessLocked loadNewDB(String path, String accessFlags) throws IOException, RecordsFileException, CacheSizeException {
		return new DBAccessLocked(path, accessFlags);
	}

	/**
	 * Creates a new DBAccessLocked instance with standard settings.
	 * @param path - Path to the file
	 * @param accessFlags  - read only(r) or read and write(rw) access
	 * @return A new {@link de.Lathanael.BinaryFileDB.API.DBAccess DBAccess} instance
	 * @throws IOException
	 ...
	 * @throws CacheSizeException
	 */
	public DBAccessLocked createNewDB(String path, String accessFlags) throws IOException, RecordsFileException, CacheSizeException {
		return new DBAccessLocked(path, initialSize, cacheSize);
	}

	/**
	 * This will load and return a new DBAccessLocked instance with custom</br>
	 * settings specified during creation of this DBAccessLocked instance.
	 * @param path - Path to the file
	 * @param accessFlags - read only(r) or read and write(rw) access
	 * @return A new {@link de.Lathanael.BinaryFileDB.API.DBAccess DBAccess} instance
	 * @throws IOException
	 ...
	 * @throws CacheSizeException
	 */
	public DBAccessLocked loadNewCustomDB(String path, String accessFlags) throws IOException, RecordsFileException, CacheSizeException {
		return new DBAccessLocked(path, accessFlags, cacheSize, MAX_KEY_LENGTH, DATA_START_HEADER_LOCATION, FILE_HEADERS_REGION_LENGTH, RECORD_HEADER_LENGTH);
	}

	/**
	 * Creates a new DBAccessLocked instance with the parameteres</br>
	 ...
	 * @throws CacheSizeException
	 */
	public DBAccessLocked createNewCustomDB(String path, String accessFlags) throws IOException, RecordsFileException, CacheSizeException {
		return new DBAccessLocked(path, initialSize, cacheSize, MAX_KEY_LENGTH, DATA_START_HEADER_LOCATION, FILE_HEADERS_REGION_LENGTH, RECORD_HEADER_LENGTH);
	}

	private void setMetrics() {
		Main.addToAccessLocked();
	...
	/**
	 * Gets the lock-instance for this DBAccessLocked instance
	 */
	public RRWLock getLock() {
		return lock;
	}
	 ...
	 */
	public RecordReader getRecord(String key) throws RecordsFileException, IOException, InterruptedException {
		reads++;
		RecordWriter rw;
	 ...
	 * @throws InterruptedException
	 */
	public void writeRecord(RecordWriter rw) throws RecordsFileException, IOException, QueueException, InterruptedException {
		writes++;
		lock.getWriteLock();
		try {
			if (useQueue) {
	 ...
	 * @throws InterruptedException
	 */
	public void appendRecord(RecordWriter rw) throws RecordsFileException, IOException, QueueException, InterruptedException {
		writes++;
		lock.getWriteLock();
		try {
			rw.setAppend(true);
	 ...
	 * @throws InterruptedException
	 */
	public void quickWriteRecord(RecordWriter rw) throws RecordsFileException, IOException, InterruptedException {
		writes++;
		lock.getWriteLock();
		try {
			if (file.recordExists(rw.getKey()))
	 ...
	 * @throws InterruptedException
	 */
	public void quickInsertRecord(RecordWriter rw) throws RecordsFileException, IOException, InterruptedException {
		writes++;
		lock.getWriteLock();
		try {
			if (file.recordExists(rw.getKey()))
	 ...
	 * @throws InterruptedException
	 */
	public void deleteRecord(String key) throws RecordsFileException, IOException, InterruptedException {
		writes++;
		lock.getWriteLock();
		try {
			if (useQueue)
	 ...
	 * @throws InterruptedException
	 */
	public void closeDB(boolean unsafe) throws IOException, RecordsFileException, InterruptedException {
		if (custom)
			Main.removeFromCustomAccessLocked();
		else
			Main.removeFromAccessLocked();
		removePlotters();
		if (unsafe)
			forceCloseDB();
		else
	 ...
	 * @throws InterruptedException
	 */
	private void safelyCloseDB() throws IOException, RecordsFileException, InterruptedException {
		lock.getWriteLock();
		try {
			if (useQueue) {
				for (Map.Entry<String, RecordWriter> entry: queue.getQueue().entrySet()) {
